    ...
    <Table className={clsx(style.table, className)}>
      <Thead>
        <Tr>
          ...
          >
            <div>
              Question Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam commodi
              consequuntur culpa doloremque fugit id minima molestiae praesentium sit. Ab ad, cumque
              eaque error nam numquam possimus reprehenderit suscipit ullam?
